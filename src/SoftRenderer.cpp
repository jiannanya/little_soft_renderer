...
int main(void)
{
    ...
    window = glfwCreateWindow(pixCols, pixRows, "SoftRenderer", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
    ...
    Texture texture = Texture(L"asset/image/wall.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 transRotate = transObj.Rotate(startPos, direction, m * 12); // 旋转
        ...
        // 将着色器的输出 映射到 FrameBuffer 中，用于显示
