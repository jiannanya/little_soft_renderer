...
std::vector<Vertex> DeviceContext::GetVertices() {
	return _vertexs;
}

void DeviceContext::SetInputLayout(InputLayout* pil) {
	inputLayout = pil;
}

void DeviceContext::SetVertexBuffer(UINT StartSloat, UINT NumBuffers, VertexBuffer* ppvb, UINT* pStrides, UINT* pOffset) {
	Vertex vertex;
...
void DeviceContext::Draw(UINT vertexCount, UINT startLoc) {

}

void DeviceContext::SetShaderProgram() {
